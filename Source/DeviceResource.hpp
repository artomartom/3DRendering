...
public:
    DeviceResource(_COM_Outptr_ ID3D11DeviceContext **ppContext, _Out_ HRESULT *hr);
    ...
    HRESULT CompileSOFromFile(_In_ LPCWSTR srcFile, _In_ LPCSTR entryPoint, _In_ LPCSTR profile, _COM_Outptr_ ID3DBlob **blob);
